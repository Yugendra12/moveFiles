...
async function uploadToGit() {
    ...
    const sourceFolderPath = path.join(__dirname,'/Users/ethiraj.haribabu/Desktop/webDardenFramework/source/','abc.feature');

    // Change to your desired destination
    const destinationFilePath = path.join(__dirname,'/Users/ethiraj.haribabu/Desktop/webDardenFramework/features','abc.feature');    
